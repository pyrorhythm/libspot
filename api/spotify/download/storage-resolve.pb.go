...
var (
	...
	file_storage_resolve_proto_rawDescData []byte
)

func file_storage_resolve_proto_rawDescGZIP() []byte {
	file_storage_resolve_proto_rawDescOnce.Do(func() {
		file_storage_resolve_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_storage_resolve_proto_rawDesc), len(file_storage_resolve_proto_rawDesc)))
	})
