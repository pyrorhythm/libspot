...
func (*PlayOrigin) Descriptor() ([]byte, []int) {
	return file_es_play_origin_proto_rawDescGZIP(), []int{0}
}
...
var (
	file_es_play_origin_proto_rawDescOnce sync.Once
	file_es_play_origin_proto_rawDescData []byte
)

func file_es_play_origin_proto_rawDescGZIP() []byte {
	file_es_play_origin_proto_rawDescOnce.Do(func() {
		file_es_play_origin_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_es_play_origin_proto_rawDesc), len(file_es_play_origin_proto_rawDesc)))
	})
	return file_es_play_origin_proto_rawDescData
}
