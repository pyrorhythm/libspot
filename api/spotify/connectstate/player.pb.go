...
type PlayerState struct {
	...
	ContextMetadata       []*PlayerState_ContextMetadataEntry `protobuf:"bytes,21,rep,name=context_metadata,json=contextMetadata,proto3" json:"context_metadata,omitempty"`
	PageMetadata          []*PlayerState_PageMetadataEntry    `protobuf:"bytes,22,rep,name=page_metadata,json=pageMetadata,proto3" json:"page_metadata,omitempty"`
...
type ProvidedTrack struct {
	...
	Metadata        []*ProvidedTrack_MetadataEntry `protobuf:"bytes,3,rep,name=metadata,proto3" json:"metadata,omitempty"`
...
type Restrictions struct {
	...
	DisallowSettingModes                                 []*Restrictions_DisallowSettingModesEntry `protobuf:"bytes,28,rep,name=disallow_setting_modes,json=disallowSettingModes,proto3" json:"disallow_setting_modes,omitempty"`
	DisallowSignals                                      []*Restrictions_DisallowSignalsEntry      `protobuf:"bytes,29,rep,name=disallow_signals,json=disallowSignals,proto3" json:"disallow_signals,omitempty"`
	DisallowPlayAsNextInQueueReasons                     []string                                  `protobuf:"bytes,30,rep,name=disallow_play_as_next_in_queue_reasons,json=disallowPlayAsNextInQueueReasons,proto3" json:"disallow_play_as_next_in_queue_reasons,omitempty"`
	DisallowSleepTimerClearReasons                       []string                                  `protobuf:"bytes,31,rep,name=disallow_sleep_timer_clear_reasons,json=disallowSleepTimerClearReasons,proto3" json:"disallow_sleep_timer_clear_reasons,omitempty"`
	DisallowSleepTimerDurationReasons                    []string                                  `protobuf:"bytes,32,rep,name=disallow_sleep_timer_duration_reasons,json=disallowSleepTimerDurationReasons,proto3" json:"disallow_sleep_timer_duration_reasons,omitempty"`
	DisallowSleepTimerEndOfTrackReasons                  []string                                  `protobuf:"bytes,33,rep,name=disallow_sleep_timer_end_of_track_reasons,json=disallowSleepTimerEndOfTrackReasons,proto3" json:"disallow_sleep_timer_end_of_track_reasons,omitempty"`
	DisallowAddToQueueTrackReasons                       []string                                  `protobuf:"bytes,34,rep,name=disallow_add_to_queue_track_reasons,json=disallowAddToQueueTrackReasons,proto3" json:"disallow_add_to_queue_track_reasons,omitempty"`
	DisallowTapToPlayTrackInNextTracksReasons            []string                                  `protobuf:"bytes,35,rep,name=disallow_tap_to_play_track_in_next_tracks_reasons,json=disallowTapToPlayTrackInNextTracksReasons,proto3" json:"disallow_tap_to_play_track_in_next_tracks_reasons,omitempty"`
	DisallowReorderingTrackInNextTracksReasons           []string                                  `protobuf:"bytes,36,rep,name=disallow_reordering_track_in_next_tracks_reasons,json=disallowReorderingTrackInNextTracksReasons,proto3" json:"disallow_reordering_track_in_next_tracks_reasons,omitempty"`
	DisallowReorderingEpisodeInNextTracksReasons         []string                                  `protobuf:"bytes,37,rep,name=disallow_reordering_episode_in_next_tracks_reasons,json=disallowReorderingEpisodeInNextTracksReasons,proto3" json:"disallow_reordering_episode_in_next_tracks_reasons,omitempty"`
	DisallowReorderingEnqueuedTrackInNextTracksReasons   []string                                  `protobuf:"bytes,38,rep,name=disallow_reordering_enqueued_track_in_next_tracks_reasons,json=disallowReorderingEnqueuedTrackInNextTracksReasons,proto3" json:"disallow_reordering_enqueued_track_in_next_tracks_reasons,omitempty"`
	DisallowReorderingEnqueuedEpisodeInNextTracksReasons []string                                  `protobuf:"bytes,39,rep,name=disallow_reordering_enqueued_episode_in_next_tracks_reasons,json=disallowReorderingEnqueuedEpisodeInNextTracksReasons,proto3" json:"disallow_reordering_enqueued_episode_in_next_tracks_reasons,omitempty"`
	DisallowViewingQueueReasons                          []string                                  `protobuf:"bytes,40,rep,name=disallow_viewing_queue_reasons,json=disallowViewingQueueReasons,proto3" json:"disallow_viewing_queue_reasons,omitempty"`
	DisallowViewingOrderedTracksInNextTracksReasons      []string                                  `protobuf:"bytes,41,rep,name=disallow_viewing_ordered_tracks_in_next_tracks_reasons,json=disallowViewingOrderedTracksInNextTracksReasons,proto3" json:"disallow_viewing_ordered_tracks_in_next_tracks_reasons,omitempty"`
	unknownFields                                        protoimpl.UnknownFields
	sizeCache                                            protoimpl.SizeCache
}
...
// Deprecated: Use PlayerState_ContextMetadataEntry.ProtoReflect.Descriptor instead.
func (*PlayerState_ContextMetadataEntry) Descriptor() ([]byte, []int) {
	return file_player_proto_rawDescGZIP(), []int{0, 0}
}
...
// Deprecated: Use PlayerState_PageMetadataEntry.ProtoReflect.Descriptor instead.
func (*PlayerState_PageMetadataEntry) Descriptor() ([]byte, []int) {
	return file_player_proto_rawDescGZIP(), []int{0, 1}
}
...
func (*ProvidedTrack_MetadataEntry) Descriptor() ([]byte, []int) {
	return file_player_proto_rawDescGZIP(), []int{1, 0}
}
...
func (*ModeRestrictions_ValuesEntry) Descriptor() ([]byte, []int) {
	return file_player_proto_rawDescGZIP(), []int{3, 0}
}
...
func (*Restrictions_DisallowSettingModesEntry) Descriptor() ([]byte, []int) {
	return file_player_proto_rawDescGZIP(), []int{5, 0}
}
...
func (*Restrictions_DisallowSignalsEntry) Descriptor() ([]byte, []int) {
	return file_player_proto_rawDescGZIP(), []int{5, 1}
}
...
func (*ContextPlayerOptions_ModesEntry) Descriptor() ([]byte, []int) {
	return file_player_proto_rawDescGZIP(), []int{7, 0}
}
...
func (*SleepTimer_None) Descriptor() ([]byte, []int) {
	return file_player_proto_rawDescGZIP(), []int{11, 0}
}
...
func (*SleepTimer_Timestamp) Descriptor() ([]byte, []int) {
	return file_player_proto_rawDescGZIP(), []int{11, 1}
}
...
func (*SleepTimer_EndOfTrack) Descriptor() ([]byte, []int) {
	return file_player_proto_rawDescGZIP(), []int{11, 2}
}
