...
func (*NormalizationParams) Descriptor() ([]byte, []int) {
	return file_audio_files_extension_proto_rawDescGZIP(), []int{0}
}
...
func (*ExtendedAudioFile) Descriptor() ([]byte, []int) {
	return file_audio_files_extension_proto_rawDescGZIP(), []int{1}
}
...
func (*AudioFilesExtensionResponse) Descriptor() ([]byte, []int) {
	return file_audio_files_extension_proto_rawDescGZIP(), []int{2}
}
...
var (
	file_audio_files_extension_proto_rawDescOnce sync.Once
	file_audio_files_extension_proto_rawDescData []byte
)

func file_audio_files_extension_proto_rawDescGZIP() []byte {
	file_audio_files_extension_proto_rawDescOnce.Do(func() {
		file_audio_files_extension_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_audio_files_extension_proto_rawDesc), len(file_audio_files_extension_proto_rawDesc)))
	})
	return file_audio_files_extension_proto_rawDescData
}
