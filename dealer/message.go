...
import (
	connectstatepb "github.com/pyrorhythm/libspot/gen/spotify/connectstate"
	playerpb "github.com/pyrorhythm/libspot/gen/spotify/player"
)
...
type Msg struct {
	...
	Key          string            `json:"key"`
	Payloads     []any             `json:"payloads"` // Message-only
...
type Command struct {
	...
	Context              *playerpb.Context          `json:"context"`
	PlayOrigin           *connectstatepb.PlayOrigin `json:"play_origin"`
	Track                *playerpb.ContextTrack     `json:"track"`
	PrevTracks           []*playerpb.ContextTrack   `json:"prev_tracks"`
	NextTracks           []*playerpb.ContextTrack   `json:"next_tracks"`
...
type Options struct {
	...
	PlayerOptionsOverride *playerpb.ContextPlayerOptionOverrides `json:"player_options_override"`
	Suppressions          *connectstatepb.Suppressions           `json:"suppressions"`
